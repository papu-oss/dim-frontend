                                ...
                                <div>
                                    <MenuButton
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="https://randomuser.me/api/portraits/women/59.jpg" alt="" />
            ...
            <DisclosurePanel class="md:hidden">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="https://randomuser.me/api/portraits/men/59.jpg"
                                alt="" />
                        </div>
                        <div class="ml-3">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <DisclosureButton v-for="item in userNavigation" :key="item.name" as="a" @click=logout
